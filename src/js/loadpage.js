    ...
    init() {
      ...
      var loadExample = function (example) {
        $.ajax({
          ...
          curCode = JSON.parse(code)
          new JsonEditor('#json-display', curCode, {})
          $('#formPage').html('');
          $('#formPage').jsonForm(curCode);
        }).fail(function () {
      ...
      var generateForm = function () {
        ...
        try {
          ...
          $('#formPage').html('<pre>Entered content is not yet a valid' +
        ...
        try {
          ...
          $('#formPage').html('<form id="result-form" class="form-vertical"></form>');
